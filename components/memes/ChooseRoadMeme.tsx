...
export const ChooseRoadMeme = ({ setMemeUrl }: any) => {
  const [text1, setText1] = useState('Facebook Tiktok');
  const [text2, setText2] = useState('Coding');
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardFooter className="text-sm text-gray-500">
        Enter two lines of text for the choose road meme
      </CardFooter>
    </Card>
  );
};

export default ChooseRoadMeme;
...
export const SadBlackManMeme  = ({ setMemeUrl }: any) => {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    setLoading(true);
    const url = `https://api.nexoracle.com/memes/sad-black-man?apikey=4aeb57e3ed0f238762&text1=${encodeURIComponent(text1)}&text2=${encodeURIComponent(text2)}`;
    setMemeUrl(url);
    setLoading(false);
  };
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardFooter className="text-sm text-gray-500">
        Enter two lines of text for the sad reaction meme
      </CardFooter>
    </Card>
  );
};

export default SadBlackManMeme ;
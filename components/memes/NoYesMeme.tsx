...
export const NoYesMeme = ({ setMemeUrl }: any) => {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    setLoading(true);
    const url = `https://api.nexoracle.com/memes/no-yes?apikey=4aeb57e3ed0f238762&text1=${encodeURIComponent(text1)}&text2=${encodeURIComponent(text2)}`;
    setMemeUrl(url);
    setLoading(false);
  };
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter the rejected option..."
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter the preferred option..."
              required
            />
          </div>
          <Button
      ...
      <CardFooter className="text-sm text-gray-500">
        Enter two options to create your no/yes preference meme
      </CardFooter>
    </Card>
  );
};

export default NoYesMeme;